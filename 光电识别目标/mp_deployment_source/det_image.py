...
def detection():
    ...
    with ScopedTiming("total",debug_mode > 0):
        ...
        # 后处理
        det_boxes = aicube.anchorbasedet_post_process( results[0], results[1], results[2], model_input_size, frame_size, strides, num_classes, confidence_threshold, nms_threshold, anchors, nms_option)
        # 绘制结果
